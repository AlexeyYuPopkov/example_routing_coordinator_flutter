...
- **Тестируемость.** (Кратко развить мысль)
...
///*
- ссылка на гит.
- обьяснение что каждая реализация в своей ветке.
*///

Пример приложения состоит из двух вкладок, у каждой свой `Navigator` и свой стек:
